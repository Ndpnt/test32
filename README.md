# Declarations of terms tracked in the *test32* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test32-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test32-versions/releases) in the `Ndpnt/test32-versions` repository.
